...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Buat Data Penduduk</h1>
    </div>
                ...
                <form action="/resident" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" inputmode="numeric" name="nik" id="nik" value="{{ old('nik') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="birth_of_date" id="birth_of_date" value="{{ old('birth_of_date') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="birth_of_place" id="birth_of_place" value="{{ old('birth_of_place') }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" id="address" cols="30" rows="10"
                                class="@error('address') border-error @enderror form-control">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="error">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" inputmode="numeric" name="phone" id="phone" value="{{ old('phone') }}"
